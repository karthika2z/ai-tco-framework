...
<div class="rel" style="grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:14px;margin:22px 0">
  ...
  <div style="background:var(--navy-mid);border:2px solid var(--gold);border-radius:13px;padding:22px;position:relative">
    <div style="position:absolute;top:-11px;right:16px;background:var(--gold);color:#1a1200;font-size:10.5px;font-weight:800;padding:4px 10px;border-radius:20px;letter-spacing:.5px">RECOMMENDED FOR ENTERPRISE</div>
